...
{
    /// <summary>2FA gerekli mi?</summary>
    public bool Requires2FA { get; set; }

    /// <summary>2FA geçici token'ı.</summary>
    public string? TempToken { get; set; }

    /// <summary>Birincil 2FA metodu: "Email", "Sms", "Authenticator"</summary>
    public string? TwoFactorMethod { get; set; }

    /// <summary>Kullanılabilir 2FA yöntemleri. Örn: ["Email", "Authenticator"]</summary>
...
/// <summary>Authenticator 2FA kurulum yanıtı — QR kod + recovery kodları.</summary>
public class SetupAuthenticatorResponseDto
{
    ...
    /// <summary>QR kod PNG görüntüsü — Base64 encoded. img src="data:image/png;base64,..." ile kullanılır.</summary>
    public string QrCodeImage { get; set; } = default!;

    /// <summary>Kurtarma kodları — tek seferlik gösterilir, kullanıcı saklamalıdır.</summary>
...
/// <summary>2FA durum bilgisi — çoklu yöntem desteği.</summary>
...
/// <summary>SMS ile 2FA aktifleştirme isteği.</summary>
public class Enable2FASmsDto
{
    public string CurrentPassword { get; set; } = default!;
    public string PhoneNumber { get; set; } = default!;
}

/// <summary>SMS doğrulama kodu onaylama isteği.</summary>
public class VerifySmsDto
{
    public string Code { get; set; } = default!;
}

/// <summary>Primary 2FA yöntemi değiştirme isteği.</summary>
public class SetPrimary2FADto
{
    public string Method { get; set; } = default!; // "Email", "Sms", "Authenticator"
}
